...
// Requerir que el usuario esté logueado y tenga rol de 'admin', 'assistant', 'solo lectura' o 'usuario'
requireRole([ROLE_ADMIN, ROLE_ASSISTANT, ROLE_READ_ONLY, ROLE_USER]);
